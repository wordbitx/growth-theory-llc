...
export function MoreProducts({ onQuickView }: MoreProductsProps) {
  ...
  return (
    <section id="more-products" ref={sectionRef} className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className={`text-gray-600 text-lg max-w-2xl mx-auto transition-all duration-700 delay-100 ${
            ...
            Explore our complete collection of digital products and services
          </p>
        </div>
